#ifndef DallasTemperatureErrorCodes_h
#define DallasTemperatureErrorCodes_h
...
enum ErrorCode {CRC_FAIL, RESET_FAIL, DEVICE_NOT_FOUND};

typedef uint8_t DeviceAddress[8];

class DallasTemperatureErrorCodes
{
public:

    DallasTemperatureErrorCodes();
    DallasTemperatureErrorCodes(OneWire*);
    ...
    bool writeScratchPad(const uint8_t*, const uint8_t*);
    ...
    enum ErrorCode getLastError(); // return the code of the last error that occurred.  Is never reset.
    ...
    bool setUserData(const uint8_t*, int16_t);
    bool setUserDataByIndex(uint8_t, int16_t);
    bool getUserData(const uint8_t*, int16_t &);
    bool getUserDataByIndex(uint8_t, int16_t &);
